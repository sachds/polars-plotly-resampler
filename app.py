...
statements = {
    "engine_temp": "SELECT Timestamp, EngineTemperature_C FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "oil_pressure": "SELECT Timestamp, OilPressure_psi FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "speed": "SELECT Timestamp, Speed_kmh FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "tire_pressure": "SELECT Timestamp, TirePressure_psi FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "battery_voltage": "SELECT Timestamp, BatteryVoltage_V FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "BrakePadWear_percent": "SELECT Timestamp, BrakePadWear_percent FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "AmbientTemperature_C": "SELECT Timestamp, AmbientTemperature_C FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "Odometer_km": "SELECT Timestamp, Odometer_km FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "EngineLoad_percent": "SELECT Timestamp, EngineLoad_percent FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "AirFlowRate_gs": "SELECT Timestamp, AirFlowRate_gs FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 20000000",
    "ThrottlePosition_percent": "SELECT Timestamp, ThrottlePosition_percent FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "EngineRPM": "SELECT Timestamp, EngineRPM FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "Acceleration_ms2": "SELECT Timestamp, Acceleration_ms2 FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "GearPosition": "SELECT Timestamp, GearPosition FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "SteeringAngle_degree": "SELECT Timestamp, SteeringAngle_degree FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "CoolantTemperature_C": "SELECT Timestamp, CoolantTemperature_C FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "FuelRate_Lh": "SELECT Timestamp, FuelRate_Lh FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
    "Altitude_m": "SELECT Timestamp, Altitude_m FROM main.resamplerdata.automobile_iot_data_bronze_sensors_1b LIMIT 2000000;",
}
